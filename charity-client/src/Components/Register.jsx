...
import { Link, useNavigate } from 'react-router'; // useNavigate, not Link for submit
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // You can add your validation & form data logic here
    ...
    <div className="min-h-screen bg-[#F5F5F0] flex items-center justify-center">
      <div className="bg-white p-13 rounded-2xl shadow-lg w-full max-w-md">
        ...
        <p className="text-center text-sm text-gray-600 mt-4">
          ...
          <Link to="/">
            <span className="text-[#e48061] hover:underline cursor-pointer">
              Log in
            </span>
          </Link>
        </p>
